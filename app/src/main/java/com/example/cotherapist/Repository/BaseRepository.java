...
public class BaseRepository {
    ...
    private final String SIGN_UP_URI = "http://cotherapist.ddns.net:5443/api/v1/accounts/sign-in";
    private final String LOGIN_URI = "http://cotherapist.ddns.net:5443/api/v1/accounts/login";
    private final String GET_TASK = "http://cotherapist.ddns.net:5443/api/v1/tasks/<task_id>";
    private final String GET_ALL_TASKS = "http://cotherapist.ddns.net:5443/api/v1/tasks";
    private final String UPLOAD_TASK = "http://cotherapist.ddns.net:5443/api/v1/tasks";
    private final String UPDATE_TASK = "http://cotherapist.ddns.net:5443/api/v1/tasks/";
    private final String DELETE_TASK = "http://cotherapist.ddns.net:5443/api/v1/tasks/";
    ...
    public static BaseRepository getInstance(final Context context) {
        if (mRepository == null) {
            mRepository = new BaseRepository(context);
        }
        return mRepository;
    }

    private BaseRepository(final Context context) {
